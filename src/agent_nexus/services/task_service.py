...
from agent_nexus.analyzer.base import AnalysisResult
from agent_nexus.models.entities import Task
...
class TaskService:
    ...
    def claim(self, task_id: str, project_id: str, project_space_id: str) -> Task:
        ...
        Raises AgentNexusError(TASK_NOT_FOUND) if task does not exist (Requirement 7.5).
        """
        task = (
            self._db.query(Task)
            .filter(
